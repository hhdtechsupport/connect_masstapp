 ...
 */
  ...
  global $user;
  if ($user->uid) {
    $block_403 = block_load('block', '36');
  } else {
    $block_403 = block_load('block', '37');
  }
  $block_403 = _block_render_blocks(array($block_403));
  $block_403 = _block_get_renderable_array($block_403);
  $block_403_title = $block_403['block_37']['#block']->title;
  $block_403_contents = $block_403['block_37']['#markup'];
?>
