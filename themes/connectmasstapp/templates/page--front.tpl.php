    ...
    <div id="container-sub">
      <div id="slider">
        <div class="main_view">
          <div class="window">
            <!-- Removed by Nancy. -->
            <!--div class="image_reel"><?php // echo variable_get('homebanners');?>            
               </div -->
          ...
          <!--div class="paging">
            <a rel="1" href="#">1</a> <a rel="2" href="#">2</a><a rel="3" href="#">3</a><a rel="4" href="#">4</a><a rel="5" href="#">5</a>
          </div-->
        </div>
      </div>
      <!-- EOF: #banner -->
      ...
      <div id="main" class="clearfix">
        <section id="post-content" role="main">
          ...
          <div class="left-column"><?php print render($page['leftnews']); ?></div>
          <div class="right-column"><?php print render($page['rightevents']); ?><br />

          <!--div class="request-service"><?php
      //echo l( '<img src="' . render(file_create_url($node->field_image['en'][0]['uri'])) . '"/>', 'masstapp-technical-assistance-request-form', array('attributes' => array('class' => array('about-link'))));
	  
	 //echo l('<img src='. path_to_theme().'/images/img-request-service.jpg />', 'masstapp-technical-assistance-request-form', array('html' => 'TRUE'));
       ...
       ?>
        ...
        <aside id="sidebar" role="complementary" class="sidebar clearfix"> <?php print render($page['sidebar_first']); ?> </aside>
        <!-- /#sidebar-first -->
        <?php endif; ?>
      </div>
      <?php endif; ?>
